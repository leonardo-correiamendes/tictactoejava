...
public class TicTacToeView extends JFrame {
    ...
    public void accueilFrame() {
        ...
        accueilPanel.setBackground(new Color(50, 50, 50));
        ...
        btnJouer.setBackground(new Color(0, 150, 136));
    ...
    public void jeuFrame() {
        ...
        grillePanel.setBackground(new Color(50, 50, 50));
        ...
        for (int i = 0; i < btnGrille.length; i++) {
            for (int j = 0; j < btnGrille[i].length; j++) {
                ...
                btnGrille[i][j].setBackground(new Color(0, 150, 136));
